...
void INS_Init(void)
{
    ...
    //user code
    KalmanCreate(&yaw_gyro_data,0.5f,0.5f);
...
void INS_Task(void)
{
    ...
    if ((count % 1) == 0)
    {
        ...
        Gimbal.Mother.yaw_angle=INS.YawTotalAngle;

        Gimbal.Mother.yaw_gyro=KalmanFilter(&yaw_gyro_data,INS.Gyro[2]);
